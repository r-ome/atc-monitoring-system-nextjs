...
const BRANCH_FILTERS: Record<string, any> = {
  ...
  container_item_categories: { container: { branch_id: undefined } },
  container_item_category_descriptions: {
    container: { branch_id: undefined },
  },
    ...
    $allModels: {
      async $allOperations({ model, operation, args, query }) {
        ...
        const shouldInjectBranchId =
          modelHasBranch && "branch_id" in BRANCH_FILTERS[model];
