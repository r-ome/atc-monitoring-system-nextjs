...
function presenter(inventory: InventoryWithDetailsRow) {
  ...
  return {
    ...
    sales_allocation: inventory.sales_allocation,
    sales_allocation_reason: inventory.sales_allocation_reason,
    sales_allocation_note: inventory.sales_allocation_note,
...
export const GetInventoryController = async (inventory_id: string) => {
  try {
    ...
    if (error instanceof NotFoundError) {
      logger("GetInventoryController", error, "warn");
